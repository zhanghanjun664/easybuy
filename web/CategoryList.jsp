            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                    <c:forEach var="item" items="${products}">
                        <li>
                            <div class="img"><a href="productDetail?pid=${item.id}"><img src="${item.fileName}" width="210" height="185" /></a></div>
                            <div class="price">
                ...
                <div class="pages">
                    <c:choose>
                        <c:when test="${pageNum>1}">
                            <a href="categoryList?cid=${cid}&pageNum=${pageNum-1}" class="p_pre">上一页</a>
                        </c:when>
                        <c:otherwise>
                    ...
                    <c:forEach varStatus="cur" items="${emptyTmp}">
                        <a href="categoryList?cid=${cid}&pageNum=${cur.index+1}">${cur.index+1}</a>
                    </c:forEach>

                    <c:choose>
                        <c:when test="${pageNum<pages}">
                            <a href="categoryList?cid=${cid}&pageNum=${pageNum+1}" class="p_pre">下一页</a>
                        </c:when>
                        <c:otherwise>
